...
class Player(pygame.sprite.Sprite):
    def __init__(
        self, source, pos_x, pos_y, num_sprites, sp_width, sp_height, sp_x0, sp_y0
    ):
        super().__init__()
        ...
        for j in range(num_sprites):
            mySprite = get_pixels_at(
                (sp_x0 + j * sp_width), sp_y0, sp_width, sp_height, source
            )
...
spriteSheet = pygame.image.load("Arcade-Pac-Man-GeneralSprites.png")
...
mazeSheet = pygame.image.load("Arcade-Pac-Man-GeneralSprites.png")
# Show the size of the sheet
